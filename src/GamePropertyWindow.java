...
public class GamePropertyWindow extends JFrame {
    public GamePropertyWindow(){
        ...
        ImageIcon withoutChoiceBG = new ImageIcon("./resources/chooiceofteam3.jpg");
        ImageIcon rusTeamChoice = new ImageIcon("./resources/rusteam5.jpg");
        ImageIcon vikTeamChoice = new ImageIcon("./resources/vikteam5.jpg");
...
//        this.getContentPane().add(jbReturnBack);
        ...
        ImageIcon startGame = new ImageIcon("./resources/table3.jpg");
        ImageIcon startGame2 = new ImageIcon("./resources/table4.jpg");
